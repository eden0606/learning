...
// moved to html-controller module, bc it is only used there
...
// below are moved to html-controller.js as a module to be reused
/*app.get('/person/:id', function(req, res) {
...
// move this to controller to make it its own module to easily use elsewhere and require it
...
// gives api-controller functions the app
apiController(app);

// gives html-controller functions the app
htmlController(app);
